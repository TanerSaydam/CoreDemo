...
{
    public partial class mh1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WirterID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WirterName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WirterAbout = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WirterImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    WirterStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
